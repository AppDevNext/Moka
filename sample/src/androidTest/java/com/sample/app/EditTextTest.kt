...
class EditTextTest {
    ...
    fun changeTextSameActivity() {
        Screenshot.takeScreenshot(activityScenarioRule.activity, "Start" + Build.VERSION.SDK_INT)
        // Type text and then press the button.
        EspressoMoka.onView(ViewMatchers.withId(R.id.editTextUserInput))
        ...
        EspressoMoka.onView(ViewMatchers.withId(R.id.textToBeChanged))
            .checkMatches(ViewMatchers.withText(STRING_TO_BE_TYPED))
        Screenshot.takeScreenshot(activityScenarioRule.activity, "End" + Build.VERSION.SDK_INT)
    }
