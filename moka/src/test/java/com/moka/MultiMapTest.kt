...
import com.moka.waiter.android.internal.SetMultiMap
...
class MultiMapTest {
    ...
    private var map: com.moka.waiter.android.internal.SetMultiMap<Int, String>? = null

    @Before
    @Throws(Exception::class)
    fun setUp() {
        map = com.moka.waiter.android.internal.SetMultiMap()
    }
